...
# Project Root Directory (one level up) -> C:\Users\hillj\repos\vortex
PROJECT_ROOT_DIRECTORY = os.path.dirname(SCRIPT_DIRECTORY)

# Path to the 'templates' directory -> C:\Users\hillj\repos\vortex\templates
TEMPLATE_PATH = os.path.join(PROJECT_ROOT_DIRECTORY, "templates")

# Path to the 'static' directory -> C:\Users\hillj\repos\vortex\static
